INSERT INTO  user (id, active, username, firstname, lastname, password) VALUES (1000, true, 'jdoe', 'John', 'Doe', '$2a$10$ckFULcsmnz2Nw/lDLh0ApuVI4L6wxOUc79g7403jtSgp2SNM4wd4a');
INSERT INTO  user (id, active, username, firstname, lastname, password) VALUES (2000, true, 'ndoe', 'Nancy', 'Doe', '$2a$10$1vySPJT4f6aDJLAFKJtvl.2qhIFlpY314ItTA9trNSOI0Y2QNJC4K');

INSERT INTO `role` VALUES (1,'GUEST');
INSERT INTO `role` VALUES (2,'ADMIN');
INSERT INTO `role` VALUES (3,'CUSTOMER');

INSERT  user_role values (1000,2);
INSERT  user_role values (2000,3);
