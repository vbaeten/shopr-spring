...
create table order_from_shop_order_lines
(
  order_from_shop_id bigint not null,
  order_lines_id     bigint not null,
  constraint UK_om4yeywnd46m9pw22rfjan2qy
  unique (order_lines_id)
)
  engine = MyISAM;

create index FK8wxvn3ykhcd9v76ssbp3uvth2
  on order_from_shop_order_lines (order_from_shop_id);
